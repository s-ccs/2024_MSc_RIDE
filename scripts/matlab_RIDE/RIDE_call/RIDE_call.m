                        ...
                        for cc = 1:n_of_c
                            ...
                            for l = 1:d3 %trial_index
                                if l_change(l,cc)==1
                                    ...
                                    %Till: tem = xcorr results for every channel of trial number l
...
%                                     tem0 = mean(tem(fix(size(tem,1)/2-cfg.dur{c_i(cc)})+1:fix(size(tem,1)/2+cfg.dur{c_i(cc)}),:));
                                    %Till: take the mean of all channels the xcorr results as the new C latencies
                            ...
                            %Till: Heuristic 3, take closest peak
